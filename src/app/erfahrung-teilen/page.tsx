    ...
    <div className="mx-auto max-w-2xl px-6 py-10">
      ...
      <form action={action} className="mt-8 space-y-6">
        ...
        <button
          ...
          className="rounded-md bg-[var(--accent)] px-5 py-2.5 text-[var(--accent-foreground)] font-medium disabled:opacity-50"
        >
          Bericht absenden
        </button>
      ...
      <div className="flex gap-2">
        {[1, 2, 3, 4, 5].map((v) => (
          <label key={v} className="text-sm">
            ...
            <span className="inline-flex h-9 w-9 items-center justify-center rounded border border-[var(--border)] bg-white cursor-pointer peer-checked:bg-[var(--accent)] peer-checked:text-[var(--accent-foreground)] peer-checked:border-[var(--accent)]">
              {v}
            </span>
          </label>
        ))}
